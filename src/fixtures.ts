...
for (const fixture of fixtures) {
  if (fixture.Group) {
    if (!fixturesByGroup[fixture.Group]) {
      fixturesByGroup[fixture.Group] = [];
    }
    fixturesByGroup[fixture.Group].push({
...
for (const group in fixturesByGroup) {
  fixturesByGroup[group].sort((first, second) => {
    return first.matchNumber - second.matchNumber;
  });
}

console.log(fixturesByGroup);
